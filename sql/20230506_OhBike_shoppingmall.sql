...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.basket:~0 rows (대략적) 내보내기
DELETE FROM `basket`;
...
INSERT INTO `detail` (`detail_no`, `product_no`, `order_no`, `option_no`, `option_num`, `product_price`, `order_status`) VALUES
	(145, 1, 96, 1, 7, 495000, '배송완료'),
	(146, 1, 96, 2, 1, 495000, '배송준비중'),
	(147, 1, 97, 2, 2, 495000, '배송준비중');
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.options:~130 rows (대략적) 내보내기
DELETE FROM `options`;
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.orders:~10 rows (대략적) 내보내기
DELETE FROM `orders`;
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.sessions:~11 rows (대략적) 내보내기
DELETE FROM `sessions`;
INSERT INTO `sessions` (`session_id`, `expires`, `data`) VALUES
	('-a02CXlDcMw5u7rbV8uFmIhgnkjxNeJ3', 1683393902, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('3ilUCmC3JMq8Cr4toDyIi1zOpnFAFsVa', 1683465938, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('7vbrcZOzzjMYii-FsOeyMQwehg0cUupi', 1683469415, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"user_no":2,"user_name":"관리자","user_lv":"admin"}'),
	('UeGMd4Q_gRNszYDB_HtJ0ZJq7Ki36OKR', 1683446063, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('Un09bpV0FC0f8rY4AAsYJ_IbGllNbIyN', 1683444462, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('atR0qivCF1z3_WnxF904BnI-PmNu_a4B', 1683446634, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('bnnb3uq7RhBaGXTomdP5d3D-1YzxHeYL', 1683444420, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('fWvOHinyavdmkC10Unz1bAl2_HAvXUHH', 1683441982, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('iV2dLbAiD6G3RrX2TmINiqlsGwUMi_F9', 1683441982, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('ll9Uo28u8mK1ajS0SdO5YCOPNUGTD6Ap', 1683437167, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('mjur9k9BGBkdczSf5KuThLVfMAKj0GyJ', 1683446531, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('pmujuIfjST5TjyJ3SP-4T-Y-brZ93QRs', 1683446295, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('r6s59774EZZqpIOVg4zjVTzoYa1WQkk-', 1683468214, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('sqjO5P0tIfQaYFe_r46lOBghOKy-WfV6', 1683446294, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('tEGkNqUSnyGHgl5UAMkKv_0OFiuZIKZG', 1683444288, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}');
