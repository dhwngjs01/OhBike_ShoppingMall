...
INSERT INTO `basket` (`basket_no`, `user_no`, `product_no`, `option_no`, `option_num`, `basket_datetime`) VALUES
	(27, 2, 1, 1, 4, '2023-03-24 10:48:46'),
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.detail:~22 rows (대략적) 내보내기
DELETE FROM `detail`;
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.orders:~23 rows (대략적) 내보내기
DELETE FROM `orders`;
...
-- 테이블 데이터 nodejs_ohbike_shoppingmall.sessions:~5 rows (대략적) 내보내기
DELETE FROM `sessions`;
INSERT INTO `sessions` (`session_id`, `expires`, `data`) VALUES
	('-a02CXlDcMw5u7rbV8uFmIhgnkjxNeJ3', 1683393902, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('9NpwxkcckraFywqmNdfVRXE0UhoaHv9p', 1680872895, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"user_no":1,"user_name":"사용자"}'),
	('hdx1WdrGd1fLEojzakOzbQbLVV5CH91X', 1683000294, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('iux0GEJiqLXghwL2T6vJjA7Fizbjqi98', 1683437309, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"user_no":2,"user_name":"관리자","user_lv":"admin"}'),
	('ll9Uo28u8mK1ajS0SdO5YCOPNUGTD6Ap', 1683437167, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}'),
	('pdZz4tvwm7gQxdgoPA_wiww7n-FHGKqT', 1680127768, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"}}');
