...
DELETE FROM `detail`;
INSERT INTO `detail` (`detail_no`, `product_no`, `order_no`, `option_no`, `product_price`, `option_num`) VALUES
	(1, 1, 1, 2, 495000, 2),
	(2, 1, 2, 2, 495000, 1),
	(3, 1, 3, 1, 495000, 1);
...
DELETE FROM `orders`;
INSERT INTO `orders` (`order_no`, `user_no`, `order_totalPrice`, `order_status`, `order_ship_name`, `order_ship_phone`, `order_ship_zipcode`, `order_ship_address`, `order_ship_detail_address`, `order_msg`, `order_date`) VALUES
	(1, 2, 995000, '배송준비중', '아무나', '010-1234-1234', 22212, '인천 미추홀구 인하로 100', NULL, '빠른 배송 부탁드립니다.', '2023-03-22 16:07:50'),
	(2, 2, 497500, '배송준비중', '아무나하나', '010-1242-1111', 22212, '인천 미추홀구 인하로 100', '인하대,인하공전,정석항공고', '빠른 배송 부탁드립니다.', '2023-03-22 16:11:30'),
	(3, 2, 497500, '배송준비중', 'ㅁㄷㅈ', '010-1234-1234', 22208, '인천 미추홀구 한나루로489번길 101', '', '빠른 배송 부탁드립니다.', '2023-03-22 18:15:25');
